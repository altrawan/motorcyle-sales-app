...
import id.sch.smkn1kawali.penjualanmotor.controllers.ControllerKaryawan;
...
import id.sch.smkn1kawali.penjualanmotor.models.tables.TableKaryawan;
 ...
 * @author Acer One
 */
public class FrmDataKaryawan extends javax.swing.JInternalFrame {
    InterfaceKaryawan i;
    List<Karyawan> l = new ArrayList<>();
    String status;
    Boolean tabel = false;
    ...
    private void initPagination() {
        try {
            ...
            // TAMPIL DATA
            TableKaryawan t = new TableKaryawan(i.findAll(nomorHalaman, jumlahBarisPerhalaman));
            tbl.setModel(t);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        FrmMasterKaryawan m = new FrmMasterKaryawan();
        m.aksi = "INSERT";
    ...
    private void tCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tCariKeyReleased
        try {
            ...
            TableKaryawan t = new TableKaryawan(l);
            tbl.setModel(t);
            tbl.getColumnModel().getColumn(9).setCellRenderer(new DateRenderer());
        } catch (SQLException ex) {
