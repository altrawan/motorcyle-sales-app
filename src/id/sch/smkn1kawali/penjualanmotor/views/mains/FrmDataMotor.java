 ...
 * @author Acer One
 */
public class FrmDataMotor extends javax.swing.JInternalFrame {
    InterfaceMotor i;
    ...
    private void initPagination() {
        try {
            ...
            // TAMPIL DATA
            TableMotor t = new TableMotor(i.findAll(nomorHalaman, jumlahBarisPerhalaman));
            tbl.setModel(t);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        FrmMasterMotor m = new FrmMasterMotor();
        m.aksi = "INSERT";
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (tabel == false) {
            ...
            m.jenis = tbl.getValueAt(row, 1).toString();
            m.tipe = tbl.getValueAt(row, 2).toString();
            m.warna = tbl.getValueAt(row, 3).toString();
            m.harga = Integer.valueOf(tbl.getValueAt(row, 4).toString());
            m.gambar = tbl.getValueAt(row, 5).toString();
            m.stok = Integer.valueOf(tbl.getValueAt(row, 6).toString());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (tabel == false) {
            ...
            int row = tbl.getSelectedRow();
            if (Messages.setConfirmMessage("Apakah Anda yakin akan menghapus data dengan tipe motor " + tbl.getValueAt(row, 2) + " ?")) {
                try {
                    Motor k = new Motor();
    ...
    private void tCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tCariKeyReleased
        try {
            ...
            TableMotor t = new TableMotor(l);
            tbl.setModel(t);
            tbl.getColumnModel().getColumn(9).setCellRenderer(new DateRenderer());
        } catch (SQLException ex) {
            Logger.getLogger(FrmDataMotor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tCariKeyReleased

    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        // TODO add your handling code here:
        new FrmLapMotor().show();
