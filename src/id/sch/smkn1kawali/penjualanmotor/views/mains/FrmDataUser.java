...
import id.sch.smkn1kawali.penjualanmotor.models.tables.TableUser;
 ...
 * @author Acer One
 */
public class FrmDataUser extends javax.swing.JInternalFrame {
    InterfaceUser i;
    ...
    private void initPagination() {
        try {
            ...
            // TAMPIL DATA
            TableUser t = new TableUser(i.findAll(nomorHalaman, jumlahBarisPerhalaman));
            tbl.setModel(t);
            tbl.getColumnModel().getColumn(6).setCellRenderer(new DateRenderer());
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        status = tbl.getValueAt(row, 5).toString();
    }//GEN-LAST:event_tblMouseClicked

    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        FrmMasterUser m = new FrmMasterUser();
        m.aksi = "INSERT";
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (tabel == false) {
            ...
            m.nama = tbl.getValueAt(row, 1).toString();
            m.username = tbl.getValueAt(row, 2).toString();
            m.email = tbl.getValueAt(row, 3).toString();
            m.role = tbl.getValueAt(row, 4).toString();
            m.status = tbl.getValueAt(row, 5).toString();
            m.show();
        }
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (tabel == false) {
            ...
            int row = tbl.getSelectedRow();
            if (Messages.setConfirmMessage("Apakah Anda yakin akan menghapus data dengan nama " + tbl.getValueAt(row, 1) + " ?")) {
                try {
                    User u = new User();
                    u.setKode(tbl.getValueAt(row, 0).toString());
    ...
    private void tCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tCariKeyReleased
        try {
            ...
            TableUser t = new TableUser(l);
            tbl.setModel(t);
            tbl.getColumnModel().getColumn(6).setCellRenderer(new DateRenderer());
        } catch (SQLException ex) {
            Logger.getLogger(FrmDataUser.class.getName()).log(Level.SEVERE, null, ex);
        }
