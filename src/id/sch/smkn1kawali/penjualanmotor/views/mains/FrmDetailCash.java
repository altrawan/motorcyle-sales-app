 ...
 * @author Acer One
 */
public class FrmDetailCash extends javax.swing.JFrame {
    public String nama, nik, alamat, tipe, warna, kode;
    public Integer harga, diskon, pajak;
    
    /**
     * Creates new form FrmDetailKredit
     */
    public FrmDetailCash() {
        initComponents();
    }
    ...
    public void loadReport() {
        ...
        try {
            ...
            prs.put("kode", kode);
            try {
                JasperDesign jDesign = JRXmlLoader.load("src/id/sch/smkn1kawali/penjualanmotor/views/reports/NotaBeliCash.jrxml");
    ...
    private void initComponents() {
        ...
        setTitle("Detail Pembelian Tunai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDetailCash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDetailCash().setVisible(true);
            }
        });
    }
