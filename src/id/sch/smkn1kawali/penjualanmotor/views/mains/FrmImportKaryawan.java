 ...
 * @author Acer One
 */
public class FrmImportKaryawan extends javax.swing.JFrame {
    String filename;
    /**
     * Creates new form FrmImportKaryawan
     */
    public FrmImportKaryawan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Import Data Karyawan");
    ...
    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportActionPerformed
        ...
        try {
            ...
            s.execute(sql);
            Messages.setInfomationMessage("Import data karyawan berhasil");
            jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImportKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmImportKaryawan().setVisible(true);
            }
        });
    }
