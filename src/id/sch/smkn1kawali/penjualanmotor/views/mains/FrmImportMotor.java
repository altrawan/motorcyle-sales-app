 ...
 * @author Acer One
 */
public class FrmImportMotor extends javax.swing.JFrame {
    String filename;
    /**
     * Creates new form FrmImportMotor
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Import Data Motor");
    ...
    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportActionPerformed
        ...
        try {
            ...
            s.execute(sql);
            Messages.setInfomationMessage("Import data motor berhasil");
            jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImportMotor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmImportMotor().setVisible(true);
            }
        });
    }
