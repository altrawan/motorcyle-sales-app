 ...
 * @author Acer One
 */
public class FrmImportUser extends javax.swing.JFrame {
    String filename;
    /**
     * Creates new form FrmImportUser
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Import Data User");
    ...
    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportActionPerformed
        ...
        try {
            ...
            s.execute(sql);
            Messages.setInfomationMessage("Import data user berhasil");
            jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImportUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmImportUser().setVisible(true);
            }
        });
    }
