 ...
 * @author Acer One
 */
public class FrmLapMotor extends javax.swing.JFrame {

    /**
     * Creates new form FrmLapMotor
     */
    public FrmLapMotor() {
        initComponents();
        Date tgl = new Date();
    ...
    public void loadReport() {
        ...
        try {
            ...
            jPanel4.revalidate();
            try {
                JasperDesign jDesign = JRXmlLoader.load("src/id/sch/smkn1kawali/penjualanmotor/views/reports/LapMotor.jrxml");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Data Motor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLapMotor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmLapMotor().setVisible(true);
            }
        });
    }
