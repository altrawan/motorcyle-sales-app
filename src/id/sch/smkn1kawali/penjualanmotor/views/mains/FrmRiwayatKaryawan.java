 ...
 * @author Acer One
 */
public class FrmRiwayatKaryawan extends javax.swing.JFrame {
    InterfaceKaryawan i;
    List<Karyawan> l = new ArrayList<>();
    Boolean tabel = false;
    
    /**
     * Creates new form FrmRiwayatKaryawan
     */
    public FrmRiwayatKaryawan() {
        initComponents();
        i = new ControllerKaryawan();
        ambil_karyawan();
    }
    
    //Mengambil kode karyawan dan nama, disimpan pada jComboBox
    ...
    private void loadAll() {
        try {
            ...
            Logger.getLogger(FrmRiwayatKaryawan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void transfer() {
        try {
            Karyawan k = i.viewLog(ButtonColumn.id);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Riwayat Karyawan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRiwayatKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRiwayatKaryawan().setVisible(true);
            }
        });
    }
