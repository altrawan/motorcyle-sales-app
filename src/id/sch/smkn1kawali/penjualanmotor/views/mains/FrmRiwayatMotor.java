 ...
 * @author Acer One
 */
public class FrmRiwayatMotor extends javax.swing.JFrame {
    InterfaceMotor i;
    List<Motor> l = new ArrayList<>();
    Boolean tabel = false;
    
    /**
     * Creates new form FrmRiwayatMotor
     */
    public FrmRiwayatMotor() {
        initComponents();
    ...
    private void loadAll() {
        try {
            ...
            Logger.getLogger(FrmRiwayatMotor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void transfer() {
        try {
            Motor k = i.viewLog(ButtonColumn.id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRiwayatMotor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRiwayatMotor().setVisible(true);
            }
        });
    }
