 ...
 * @author Acer One
 */
public class FrmRiwayatUser extends javax.swing.JFrame {
    InterfaceUser i;
    List<User> l = new ArrayList<>();
    Boolean tabel = false;
    
    /**
     * Creates new form FrmRiwayatUser
     */
    public FrmRiwayatUser() {
        initComponents();
    ...
    private void loadAll() {
        try {
            ...
            Logger.getLogger(FrmRiwayatUser.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void transfer() {
        try {
            User u = i.viewLog(ButtonColumn.id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRiwayatUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRiwayatUser().setVisible(true);
            }
        });
    }
